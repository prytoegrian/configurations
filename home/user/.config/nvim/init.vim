" Cf. https://wwoods.github.io/2015/07/29/nvim-config/
" Cf. https://www.freecodecamp.org/news/a-guide-to-modern-web-development-with-neo-vim-333f7efbf8e2/
...
set updatetime=500
" Enable mouse click to go to position
set mouse=a
